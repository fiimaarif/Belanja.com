...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.11.4/r-2.2.9/sb-1.3.1/datatables.min.css"/>
    @stack('addon-style')
  </head>
  ...
  <body>
      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="/images/admin.png" class="my-4" alt="" style="width: 80px;">
          </div>
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.11.4/r-2.2.9/sb-1.3.1/datatables.min.js"></script>
